...
Deserializers["Luna.Unity.DTO.UnityEngine.Textures.Texture2D"] = function (request, data, root) {
  var i852 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Textures.Texture2D' )
  var i853 = data
  i852.name = i853[0]
  i852.width = i853[1]
  i852.height = i853[2]
  i852.mipmapCount = i853[3]
  i852.anisoLevel = i853[4]
  i852.filterMode = i853[5]
  i852.hdr = !!i853[6]
  i852.format = i853[7]
  i852.wrapMode = i853[8]
  i852.alphaIsTransparency = !!i853[9]
  i852.alphaSource = i853[10]
  i852.graphicsFormat = i853[11]
  i852.sRGBTexture = !!i853[12]
  i852.desiredColorSpace = i853[13]
  i852.wrapU = i853[14]
  i852.wrapV = i853[15]
  return i852
}
...
Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material"] = function (request, data, root) {
  var i854 = root || new pc.UnityMaterial()
  var i855 = data
  i854.name = i855[0]
  request.r(i855[1], i855[2], 0, i854, 'shader')
  i854.renderQueue = i855[3]
  i854.enableInstancing = !!i855[4]
  var i857 = i855[5]
  var i856 = []
  for(var i = 0; i < i857.length; i += 1) {
    i856.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+FloatParameter', i857[i + 0]) );
  }
  i854.floatParameters = i856
  var i859 = i855[6]
  var i858 = []
  for(var i = 0; i < i859.length; i += 1) {
    i858.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+ColorParameter', i859[i + 0]) );
  }
  i854.colorParameters = i858
  var i861 = i855[7]
  var i860 = []
  for(var i = 0; i < i861.length; i += 1) {
    i860.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+VectorParameter', i861[i + 0]) );
  }
  i854.vectorParameters = i860
  var i863 = i855[8]
  var i862 = []
  for(var i = 0; i < i863.length; i += 1) {
    i862.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+TextureParameter', i863[i + 0]) );
  }
  i854.textureParameters = i862
  var i865 = i855[9]
  var i864 = []
  for(var i = 0; i < i865.length; i += 1) {
    i864.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+MaterialFlag', i865[i + 0]) );
  }
  i854.materialFlags = i864
  return i854
}

Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+FloatParameter"] = function (request, data, root) {
  var i868 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+FloatParameter' )
  var i869 = data
  i868.name = i869[0]
  i868.value = i869[1]
  return i868
...
Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+ColorParameter"] = function (request, data, root) {
  var i872 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+ColorParameter' )
  var i873 = data
  i872.name = i873[0]
  i872.value = new pc.Color(i873[1], i873[2], i873[3], i873[4])
  return i872
}

Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+VectorParameter"] = function (request, data, root) {
  var i876 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+VectorParameter' )
  var i877 = data
  i876.name = i877[0]
  i876.value = new pc.Vec4( i877[1], i877[2], i877[3], i877[4] )
  return i876
}

Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+TextureParameter"] = function (request, data, root) {
  var i880 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+TextureParameter' )
  var i881 = data
  i880.name = i881[0]
  request.r(i881[1], i881[2], 0, i880, 'value')
  return i880
}

Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+MaterialFlag"] = function (request, data, root) {
  var i884 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+MaterialFlag' )
  var i885 = data
  i884.name = i885[0]
  i884.enabled = !!i885[1]
  return i884
