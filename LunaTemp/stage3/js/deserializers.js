...
Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material"] = function (request, data, root) {
  var i838 = root || new pc.UnityMaterial()
  var i839 = data
  i838.name = i839[0]
  request.r(i839[1], i839[2], 0, i838, 'shader')
  i838.renderQueue = i839[3]
  i838.enableInstancing = !!i839[4]
  var i841 = i839[5]
  var i840 = []
  for(var i = 0; i < i841.length; i += 1) {
    i840.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+FloatParameter', i841[i + 0]) );
  }
  i838.floatParameters = i840
  var i843 = i839[6]
  var i842 = []
  for(var i = 0; i < i843.length; i += 1) {
    i842.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+ColorParameter', i843[i + 0]) );
  }
  i838.colorParameters = i842
  var i845 = i839[7]
  var i844 = []
  for(var i = 0; i < i845.length; i += 1) {
    i844.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+VectorParameter', i845[i + 0]) );
  }
  i838.vectorParameters = i844
  var i847 = i839[8]
  var i846 = []
  for(var i = 0; i < i847.length; i += 1) {
    i846.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+TextureParameter', i847[i + 0]) );
  }
  i838.textureParameters = i846
  var i849 = i839[9]
  var i848 = []
  for(var i = 0; i < i849.length; i += 1) {
    i848.push( request.d('Luna.Unity.DTO.UnityEngine.Assets.Material+MaterialFlag', i849[i + 0]) );
  }
  i838.materialFlags = i848
  return i838
}

Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+FloatParameter"] = function (request, data, root) {
  var i852 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+FloatParameter' )
  var i853 = data
  i852.name = i853[0]
  i852.value = i853[1]
  return i852
...
Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+ColorParameter"] = function (request, data, root) {
  var i856 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+ColorParameter' )
  var i857 = data
  i856.name = i857[0]
  i856.value = new pc.Color(i857[1], i857[2], i857[3], i857[4])
  return i856
}

Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+VectorParameter"] = function (request, data, root) {
  var i860 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+VectorParameter' )
  var i861 = data
  i860.name = i861[0]
  i860.value = new pc.Vec4( i861[1], i861[2], i861[3], i861[4] )
  return i860
}

Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+TextureParameter"] = function (request, data, root) {
  var i864 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+TextureParameter' )
  var i865 = data
  i864.name = i865[0]
  request.r(i865[1], i865[2], 0, i864, 'value')
  return i864
}

Deserializers["Luna.Unity.DTO.UnityEngine.Assets.Material+MaterialFlag"] = function (request, data, root) {
  var i868 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Assets.Material+MaterialFlag' )
  var i869 = data
  i868.name = i869[0]
  i868.enabled = !!i869[1]
  return i868
...
Deserializers["Luna.Unity.DTO.UnityEngine.Textures.Texture2D"] = function (request, data, root) {
  var i870 = root || request.c( 'Luna.Unity.DTO.UnityEngine.Textures.Texture2D' )
  var i871 = data
  i870.name = i871[0]
  i870.width = i871[1]
  i870.height = i871[2]
  i870.mipmapCount = i871[3]
  i870.anisoLevel = i871[4]
  i870.filterMode = i871[5]
  i870.hdr = !!i871[6]
  i870.format = i871[7]
  i870.wrapMode = i871[8]
  i870.alphaIsTransparency = !!i871[9]
  i870.alphaSource = i871[10]
  i870.graphicsFormat = i871[11]
  i870.sRGBTexture = !!i871[12]
  i870.desiredColorSpace = i871[13]
  i870.wrapU = i871[14]
  i870.wrapV = i871[15]
  return i870
}
...
Deserializers.buildID = "aa4475dc-ee29-4022-9365-971dc4a3dcad";
