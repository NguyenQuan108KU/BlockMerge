...
public class PopupToast : Panel
{
    ...
    private readonly Service<PoolingContainerService> poolingContainer = new SonatFramework.Systems.Service<SonatFramework.Systems.ObjectPooling.PoolingContainerService>();
