...
namespace SonatFramework.Scripts.Helper
{
    public static class TransformExtensions
    {
        ...
        public static void SetSizeDeltaY(this Image img, float y)
        {
            img.rectTransform.sizeDelta = new Vector2(img.rectTransform.sizeDelta.x, y);
        }
        ...
        public static void LookAt2D_YAxis(this Transform tf, Vector2 targetPos)
        {
            Vector2 dir = targetPos - (Vector2)tf.position;
