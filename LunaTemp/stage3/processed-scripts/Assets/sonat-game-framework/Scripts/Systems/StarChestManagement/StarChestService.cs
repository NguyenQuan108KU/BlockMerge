...
public class StarChestService : SonatServiceSo, IServiceInitialize
{
    ...
    public void CollectStarInGame([Bridge.Ref] Vector3 position)
    {
    ...
    protected void OnLevelStarted([Bridge.Ref] LevelStartedEvent levelStartedEvent)
    {
        star = 0;
        combo = comboServiceTime.Combo;
    }

    protected void OnLevelEnded([Bridge.Ref] LevelEndedEvent eventData)
    {
