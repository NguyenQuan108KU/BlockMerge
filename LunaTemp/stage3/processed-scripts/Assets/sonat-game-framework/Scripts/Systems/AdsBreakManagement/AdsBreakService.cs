...
namespace SonatFramework.Systems.AdsBreakManagement
{
    ...
    public class AdsBreakService : SonatServiceSo, IServiceInitialize
    {
        ...
        public void OnStartLevel([Bridge.Ref] LevelStartedEvent eventData)
        {
        ...
        private void OnLevelEnd([Bridge.Ref] LevelEndedEvent eventData)
        {
            StopWaitAdBreak();
        }

        private void OnLevelStuck([Bridge.Ref] LevelStuckEvent eventData)
        {
            StopWaitAdBreak();
        }

        public void OnSwitchPlacement([Bridge.Ref] SwitchPlacementEvent eventData)
        {
