...
namespace SonatFramework.Systems.BoosterManagement
{
    public class UIBoosterBase : MonoBehaviour
    {
        ...
        [SerializeField] protected readonly Service<BoosterService> boosterService = new SonatFramework.Systems.Service<SonatFramework.Systems.BoosterManagement.BoosterService>();
        ...
        protected virtual void OnAddBooster([Bridge.Ref] AddResourceVisualEvent eventData)
        {
        ...
        protected virtual void OnResourceUpdate([Bridge.Ref] GameResourceKey gameResourceKey)
        {
