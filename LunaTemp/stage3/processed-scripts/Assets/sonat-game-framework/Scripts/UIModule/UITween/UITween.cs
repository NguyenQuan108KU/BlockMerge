...
namespace SonatFramework.Scripts.UIModule
{
    ...
    {
        public static async Task Play(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
            tweenData.SetupData();
        ...
        private static async Task PlayTweenScale(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async Task PlayTweenFade(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async Task PlayTweenMove(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
            var target = tweenData.target;
        ...
        private static async Task PlayTweenLocalMove(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
            var target = tweenData.target;
        ...
        private static async Task PlayTweenRectLocalMove(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async Task PlayTweenFadeGroup(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async Task PlayTweenActive(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async Task PlayTweenInActive(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
