...
namespace SonatFramework.Scripts.UIModule
{
    ...
    {
        public static async UniTask Play(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
            tweenData.SetupData();
        ...
        private static async UniTask PlayTweenScale(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async UniTask PlayTweenFade(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async UniTask PlayTweenMove(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
            var target = tweenData.target;
        ...
        private static async UniTask PlayTweenLocalMove(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
            var target = tweenData.target;
        ...
        private static async UniTask PlayTweenRectLocalMove(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async UniTask PlayTweenFadeGroup(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async UniTask PlayTweenActive(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
        ...
        private static async UniTask PlayTweenInActive(TweenData tweenData, [Bridge.Ref] CancellationToken ctk)
        {
