...
public class CollectEffectMultipleStar : SonatCollectEffect
{
    ...
    private async UniTask Spawn([Bridge.Ref] GameResourceKey key, int quantity, [Bridge.Ref] Vector3 startPos, [Bridge.Ref] Vector3 endPos, Action<int> onFinishStep, Action callback)
    {
