...
namespace Sonat
{
    ...
    public class SonatSdkServices : ScriptableObject
    {
        ...
        {
            serviceDictionary = new System.Collections.Generic.Dictionary<System.Type, Sonat.SonatService>();
#if UNITY_EDITOR
            ...
            serviceInProcess = new System.Collections.Generic.List<Sonat.ISonatService>();

            servicesInstance = new System.Collections.Generic.List<Sonat.SonatService>();
