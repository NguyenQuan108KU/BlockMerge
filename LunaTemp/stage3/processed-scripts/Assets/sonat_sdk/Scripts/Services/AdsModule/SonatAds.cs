...
namespace Sonat.AdsModule
{
    ...
    public class SonatAds : SonatService
    {
        ...
        private Dictionary<AdPlacement, List<AdUnit>> adUnits = new System.Collections.Generic.Dictionary<Sonat.AdsModule.AdPlacement, System.Collections.Generic.List<Sonat.AdsModule.AdUnit>>();

        private readonly Dictionary<AdPlacement, float> lastTimeShowAds = new System.Collections.Generic.Dictionary<Sonat.AdsModule.AdPlacement, float>();

        public readonly Dictionary<AdPlacement, string> adShowPlacement = new System.Collections.Generic.Dictionary<Sonat.AdsModule.AdPlacement, string>();
