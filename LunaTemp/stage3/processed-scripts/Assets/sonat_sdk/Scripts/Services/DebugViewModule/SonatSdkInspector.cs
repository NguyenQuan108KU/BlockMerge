...
namespace Sonat.DebugViewModule
{
    ...
    public class SonatSdkInspector
    {
        ...
        public static SonatSdkInspector GetInstance()
        {
            lock (_sLock)
            {
                _sInstance = _sInstance ?? new SonatSdkInspector();
                return _sInstance;
            }
        }
        ...
        {
            List<LibRequiredDataValidateResult> results = new System.Collections.Generic.List<Sonat.DebugViewModule.LibRequiredDataValidateResult>();
        ...
        {
            LibRequiredDataValidateResult result = new Sonat.DebugViewModule.LibRequiredDataValidateResult()
            {
                Name = lib.name,
                IsValid = false,
        ...
        {
            List<SignatureInfo> results = new System.Collections.Generic.List<Sonat.DebugViewModule.SignatureInfo>();
            try
            {
    ...
    public class LoadingIndicatorWithoutMonoBehaviour
    {
        ...
        private Texture2D CreateQquareTexture(int size, [Bridge.Ref] Color32 color)
        {
