...
namespace Sonat.FirebaseModule
{
    public sealed class SonatFirebaseRemoteConfig
    {
        ...
        private Dictionary<string, RemoteDataByLevel> remoteDataByLevels = new System.Collections.Generic.Dictionary<string, Sonat.FirebaseModule.RemoteConfig.RemoteDataByLevel>();
        private Dictionary<string, Dictionary<string, RemoteDataByLevel>> remoteDataByLevelsSegment = new System.Collections.Generic.Dictionary<string, System.Collections.Generic.Dictionary<string, Sonat.FirebaseModule.RemoteConfig.RemoteDataByLevel>>();
        ...
        //[ArrayElementTitleSonatSdk(nameof(RemoteConfigDefaultByKey.key))] [SerializeField]
        public List<RemoteConfigDefaultByString> defaultConfigs = new System.Collections.Generic.List<Sonat.FirebaseModule.RemoteConfig.RemoteConfigDefaultByString>();
