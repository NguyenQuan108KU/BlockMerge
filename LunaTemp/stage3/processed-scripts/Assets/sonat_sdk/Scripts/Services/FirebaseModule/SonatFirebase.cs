...
namespace Sonat.FirebaseModule
{
    ...
    public class SonatFirebase : SonatService
    {
        ...
        public static readonly SonatFirebaseRemoteConfig remote = new Sonat.FirebaseModule.SonatFirebaseRemoteConfig();
        public static readonly SonatFirebaseMessage message = new Sonat.FirebaseModule.Message.SonatFirebaseMessage();
        public static readonly SonatFirebaseAnalytic analytic = new Sonat.FirebaseModule.Analytic.SonatFirebaseAnalytic();
#if using_firebase_installation
