...
namespace DG.Tweening
{
    ...
    public class DOTweenTMPAnimator : IDisposable
    {
        ...
        public void SetCharColor(int charIndex, [Bridge.Ref] Color32 color)
        {
        ...
        public void SetCharOffset(int charIndex, [Bridge.Ref] Vector3 offset)
        {
            if (!ValidateChar(charIndex)) return;
            CharTransform c = _charTransforms[charIndex];
        ...
        public void SetCharRotation(int charIndex, [Bridge.Ref] Vector3 rotation)
        {
            if (!ValidateChar(charIndex)) return;
            CharTransform c = _charTransforms[charIndex];
        ...
        public void SetCharScale(int charIndex, [Bridge.Ref] Vector3 scale)
        {
            if (!ValidateChar(charIndex)) return;
            CharTransform c = _charTransforms[charIndex];
        ...
        public void ShiftCharVertices(int charIndex, [Bridge.Ref] Vector3 topLeftShift, [Bridge.Ref] Vector3 topRightShift, [Bridge.Ref] Vector3 bottomLeftShift, [Bridge.Ref] Vector3 bottomRightShift)
        {
            if (!ValidateChar(charIndex)) return;
            CharTransform c = _charTransforms[charIndex];
        ...
        /// <param name="charIndex">The index of the character to tween (will throw an error if it doesn't exist)</param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public TweenerCore<Color, Color, ColorOptions> DOColorChar(int charIndex, [Bridge.Ref] Color endValue, float duration)
        {
            if (!ValidateChar(charIndex)) return null;
        ...
        /// <param name="charIndex">The index of the character to tween (will throw an error if it doesn't exist)</param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public TweenerCore<Vector3, Vector3, VectorOptions> DOOffsetChar(int charIndex, [Bridge.Ref] Vector3 endValue, float duration)
        {
            if (!ValidateChar(charIndex)) return null;
        ...
        public TweenerCore<Quaternion, Vector3, QuaternionOptions> DORotateChar(int charIndex, [Bridge.Ref] Vector3 endValue, float duration, RotateMode mode = RotateMode.Fast)
        {
            if (!ValidateChar(charIndex)) return null;
        ...
        /// <param name="charIndex">The index of the character to tween (will throw an error if it doesn't exist)</param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        public TweenerCore<Vector3, Vector3, VectorOptions> DOScaleChar(int charIndex, [Bridge.Ref] Vector3 endValue, float duration)
        {
            if (!ValidateChar(charIndex)) return null;
        ...
        public Tweener DOPunchCharOffset(int charIndex, [Bridge.Ref] Vector3 punch, float duration, int vibrato = 10, float elasticity = 1)
        {
            if (!ValidateChar(charIndex)) return null;
            if (duration <= 0) {
        ...
        public Tweener DOPunchCharRotation(int charIndex, [Bridge.Ref] Vector3 punch, float duration, int vibrato = 10, float elasticity = 1)
        {
            if (!ValidateChar(charIndex)) return null;
            if (duration <= 0) {
                if (Debugger.logPriority > 0) Debug.LogWarning("Duration can't be 0, returning NULL without creating a tween");
        ...
        /// 1 creates a full oscillation between the punch scale and the opposite scale,
        /// while 0 oscillates only between the punch scale and the start scale</param>
        public Tweener DOPunchCharScale(int charIndex, [Bridge.Ref] Vector3 punch, float duration, int vibrato = 10, float elasticity = 1)
        {
            if (!ValidateChar(charIndex)) return null;
            if (duration <= 0) {
                if (Debugger.logPriority > 0) Debug.LogWarning("Duration can't be 0, returning NULL without creating a tween");
        ...
        /// Setting it to 0 will shake along a single direction.</param>
        /// <param name="fadeOut">If TRUE the shake will automatically fadeOut smoothly within the tween's duration, otherwise it will not</param>
        public Tweener DOShakeCharOffset(int charIndex, float duration, [Bridge.Ref] Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            if (!ValidateChar(charIndex)) return null;
            if (duration <= 0) {
                if (Debugger.logPriority > 0) Debug.LogWarning("Duration can't be 0, returning NULL without creating a tween");
        ...
        /// Setting it to 0 will shake along a single direction.</param>
        /// <param name="fadeOut">If TRUE the shake will automatically fadeOut smoothly within the tween's duration, otherwise it will not</param>
        public Tweener DOShakeCharRotation(int charIndex, float duration, [Bridge.Ref] Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            if (!ValidateChar(charIndex)) return null;
            if (duration <= 0) {
                if (Debugger.logPriority > 0) Debug.LogWarning("Duration can't be 0, returning NULL without creating a tween");
        ...
        /// Setting it to 0 will shake along a single direction.</param>
        /// <param name="fadeOut">If TRUE the shake will automatically fadeOut smoothly within the tween's duration, otherwise it will not</param>
        public Tweener DOShakeCharScale(int charIndex, float duration, [Bridge.Ref] Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            if (!ValidateChar(charIndex)) return null;
            if (duration <= 0) {
                if (Debugger.logPriority > 0) Debug.LogWarning("Duration can't be 0, returning NULL without creating a tween");
        ...
        struct CharTransform
        {
            ...
            public void UpdateAlpha(TMP_Text target, [Bridge.Ref] Color alphaColor, TMP_MeshInfo[] meshInfos, bool apply = true)
            {
            ...
            public void UpdateColor(TMP_Text target, [Bridge.Ref] Color32 color, TMP_MeshInfo[] meshInfos, bool apply = true)
            {
                Color32[] vertexCols = meshInfos[_matIndex].colors32;
                vertexCols[_firstVertexIndex] = color;
                vertexCols[_firstVertexIndex + 1] = color;
            ...
            public void UpdateGeometry(TMP_Text target, [Bridge.Ref] Vector3 offset, [Bridge.Ref] Quaternion rotation, [Bridge.Ref] Vector3 scale, TMP_MeshInfo[] cachedMeshInfos, bool apply = true)
            {
                this.offset = offset;
            ...
            public void ShiftVertices(TMP_Text target, [Bridge.Ref] Vector3 topLeftShift, [Bridge.Ref] Vector3 topRightShift, [Bridge.Ref] Vector3 bottomLeftShift, [Bridge.Ref] Vector3 bottomRightShift)
            {
