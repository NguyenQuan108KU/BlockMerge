...
public class BlockVisual : MonoBehaviour, IPoolingObject
{
    ...
    public void ResolveMesh([Bridge.Ref] Vector2Int cellPos, HashSet<Vector2Int> shapeOffsets, CellMeshLibrary lib)
    {
    ...
    public void SetupInnerMesh(Mesh mesh, Material innerMat, [Bridge.Ref] Vector3 scale, [Bridge.Ref] Vector3 offset)
    {
        FindOuterInnerReferences();
