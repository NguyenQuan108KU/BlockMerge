...
namespace TowerStack.LevelManagement
{
    ...
    public class LevelDataJson
    {
        ...
        public List<BlockPlacement> mapData = new System.Collections.Generic.List<TowerStack.LevelManagement.BlockPlacement>();
        public List<string> fixedStartSequenceKeys = new System.Collections.Generic.List<string>();
    }
