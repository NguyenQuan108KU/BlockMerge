...
[Bridge.Ref]         PreplacedBlockData data,
        int elementIndex,
...
[Bridge.Ref]         Vector2Int offset,
    ...
    private async UniTask<BlockShapeSO> LoadShape([Bridge.Ref] PreplacedBlockData data, int elementIndex)
    {
    ...
    private bool ValidateCellWithTwin([Bridge.Ref] Vector2Int cellPos, int elementIndex, HashSet<Vector2Int> occupiedCells, SpawnStats stats)
    {
        int tx = cellPos.x;
        int ty = cellPos.y;
