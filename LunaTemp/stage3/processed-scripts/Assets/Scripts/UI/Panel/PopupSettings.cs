...
public class PopupSettings : Panel
{
    ...
    private readonly Service<AudioService> _audioService = new SonatFramework.Systems.Service<SonatFramework.Systems.AudioManagement.AudioService>();
    private readonly Service<VibrationService> _vibrationService = new SonatFramework.Systems.Service<SonatFramework.Systems.SettingsManagement.Vibation.VibrationService>();
