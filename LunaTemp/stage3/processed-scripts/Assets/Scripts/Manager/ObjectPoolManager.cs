...
{
    public Dictionary<string, Queue<GameObject>> pools = new System.Collections.Generic.Dictionary<string, System.Collections.Generic.Queue<UnityEngine.GameObject>>();
    public Dictionary<string, GameObject> loadedPrefabs = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>();
    ...
    public GameObject SpawnSync(string key, [Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot, Transform parent = null, bool useLocalSpace = false)
    {
    ...
    public async UniTask<GameObject> SpawnAsync(string key, [Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot, Transform parent = null, bool useLocalSpace = false)
    {
