...
public class InputManager : SingletonSimple<InputManager>
{
    ...
    private void OnBlockSpawned([Bridge.Ref] BlockSpawnedEvent e)
    {
    ...
    private void HandleDragging([Bridge.Ref] Vector2 currentPos)
    {
    ...
    private void ProcessGameDrag([Bridge.Ref] Vector2 currentPos)
    {
